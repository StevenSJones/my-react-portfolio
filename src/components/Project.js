...
export default function Project(props) {
  const projects = [
    ...
    },
    {
      ...
      url: "",
      title: "Project 1",
      description: "√ - Project 1 allows the user to look up city information using API calls. Perhaps you are visiting a new city and would like to know a few of the activities in the area that weekend then this app is for you. Click the Project 1 button to proceed to the site.",
    },
    {
      src: "",
      url: "",
    ...
    },
    {
      src: "",
      url: "",
      title: "The Fitness Tracker",
      description: " √ - The Fitness Tracker allows you to track your fitness by keeping track of your workouts in a personalised db experience. Press the button below to visit the site.",
    },
    {
      src: "",
      url: "",
