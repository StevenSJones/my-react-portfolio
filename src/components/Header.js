  ...
  return (
    ...
    <div className="container">
      ...
      >
        <div className="row">
          <div className="col">
        <Navbar.Brand href="/"><h3 className="text-shadow-light-font-light">Welcome</h3></Navbar.Brand>
        </div>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="mr-auto">
            ...
            <NavDropdown className="text-shadow-light-font-light" title="More Below" id="collasible-nav-dropdown">
              <NavDropdown.Item href="./resume.html"><h1 className="link-text text-shadow-dark" target="_blank">Resume</h1></NavDropdown.Item>
              <NavDropdown.Item href="https://github.com/StevenSJones"><h1 className="link-text text-shadow-dark" target="_blank">GITHUB</h1></NavDropdown.Item>
              <NavDropdown.Item href="https://www.linkedin.com/in/steven-j-285a33115"><h1 className="link-text text-shadow-dark" target="_blank">LinkedIn</h1></NavDropdown.Item>
            </NavDropdown>
            </div>
          </Nav>
        </Navbar.Collapse>
